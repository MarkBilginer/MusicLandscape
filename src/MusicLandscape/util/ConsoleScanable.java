 ...
 * (with a text-based user interface). Implementing classes provide a method scan that guides the user through
 * the process of reviewing and possibly changing current values. The resulting object is in a consistent state,
...
public interface ConsoleScanable {
     ...
     * Implementing classes may chose to provide a cancel mechanism and/or a keep-old-value mechanism. The user interaction is completely left to implementing classes and must be documented there. Documentation should include:
